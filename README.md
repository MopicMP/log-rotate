...
[![PyPI version](https://badge.fury.io/py/log-rotate.svg)](https://pypi.org/project/log-rotate/)
...
result = rotate("Hello World")

# Example 2: Batch processing
from log_rotate import batch
